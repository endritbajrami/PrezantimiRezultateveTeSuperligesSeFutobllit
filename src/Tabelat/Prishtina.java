...
public class Prishtina {
	...
	public Prishtina(int eid, int Numri, String Shtetesia, String Pozicioni,String EmriMbiemri) {
		this.eid = eid;
		this.Numri = Numri;
	...
	public static List<Prishtina> getprishtina() {
		List<Prishtina> prishtinaList = new ArrayList();
		
		String query = "Select * from prishtina";
		...
		try {
			...
			while(resultSet.next()) {
				Prishtina prishtina = new Prishtina(resultSet.getInt(1), resultSet.getInt(2), resultSet.getString(3), resultSet.getString(4), resultSet.getString(5));
				prishtinaList.add(prishtina);
			}
		} catch(SQLException ex) {
			ex.printStackTrace();
		}
		
		return prishtinaList;
	}
}
